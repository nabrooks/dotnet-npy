...
namespace DotNetNpyIo
{
    ...
    public abstract class EndianBitConverter
    {
        ...
        /// <summary>
        /// Copies the specified Boolean values into the specified byte array,
        /// beginning at the specified index.
        /// </summary>
        /// <param name="values">A Boolean value.</param>
        /// <param name="buffer">The byte array to copy the bytes into</param>
        /// <param name="index">The first index into the array to copy the bytes into</param>
        public void CopyBytes(bool[] values, byte[] buffer, int index)
        {
        ...
        /// <summary>
        /// Copies the specified Character values into the specified byte array,
        /// beginning at the specified index.
        /// </summary>
        /// <param name="values">A Boolean value.</param>
        /// <param name="buffer">The byte array to copy the bytes into</param>
        /// <param name="index">The first index into the array to copy the bytes into</param>
        public void CopyBytes(char[] values, byte[] buffer, int index)
        {
            foreach (var value in values)
            {
                CopyBytes(value, buffer, index);
        ...
        /// <summary>
        /// Copies the specified Double-precision floating point values into the specified byte array,
        /// beginning at the specified index.
        /// </summary>
        /// <param name="values">A Boolean value.</param>
        /// <param name="buffer">The byte array to copy the bytes into</param>
        /// <param name="index">The first index into the array to copy the bytes into</param>
        public void CopyBytes(double[] values, byte[] buffer, int index)
        {
            foreach (var value in values)
            {
                CopyBytes(value, buffer, index);
        ...
        /// <summary>
        /// Copies the specified 16-bit signed integer values into the specified byte array,
        /// beginning at the specified index.
        /// </summary>
        /// <param name="values">A Boolean value.</param>
        /// <param name="buffer">The byte array to copy the bytes into</param>
        /// <param name="index">The first index into the array to copy the bytes into</param>
        public void CopyBytes(short[] values, byte[] buffer, int index)
        {
            foreach (var value in values)
            {
                CopyBytes(value, buffer, index);
        ...
        /// <summary>
        /// Copies the specified 32-bit signed integer values into the specified byte array,
        /// beginning at the specified index.
        /// </summary>
        /// <param name="values">A Boolean value.</param>
        /// <param name="buffer">The byte array to copy the bytes into</param>
        /// <param name="index">The first index into the array to copy the bytes into</param>
        public void CopyBytes(int[] values, byte[] buffer, int index)
        {
            foreach (var value in values)
            {
                CopyBytes(value, buffer, index);
        ...
        /// <summary>
        /// Copies the specified 64-bit signed integer values into the specified byte array,
        /// beginning at the specified index.
        /// </summary>
        /// <param name="values">A Boolean value.</param>
        /// <param name="buffer">The byte array to copy the bytes into</param>
        /// <param name="index">The first index into the array to copy the bytes into</param>
        public void CopyBytes(long[] values, byte[] buffer, int index)
        {
            foreach (var value in values)
            {
                CopyBytes(value, buffer, index);
        ...
        /// <summary>
        /// Copies the specified Single-precision floating point values into the specified byte array,
        /// beginning at the specified index.
        /// </summary>
        /// <param name="values">A Boolean value.</param>
        /// <param name="buffer">The byte array to copy the bytes into</param>
        /// <param name="index">The first index into the array to copy the bytes into</param>
        public void CopyBytes(float[] values, byte[] buffer, int index)
        {
            foreach (var value in values)
            {
                CopyBytes(value, buffer, index);
        ...
        /// <summary>
        /// Copies the specified 16-bit unsigned integer values into the specified byte array,
        /// beginning at the specified index.
        /// </summary>
        /// <param name="values">A Boolean value.</param>
        /// <param name="buffer">The byte array to copy the bytes into</param>
        /// <param name="index">The first index into the array to copy the bytes into</param>
        public void CopyBytes(ushort[] values, byte[] buffer, int index)
        {
            foreach (var value in values)
            {
                CopyBytes(value, buffer, index);
        ...
        /// <summary>
        /// Copies the specified 32-bit unsigned integer values into the specified byte array,
        /// beginning at the specified index.
        /// </summary>
        /// <param name="values">A Boolean value.</param>
        /// <param name="buffer">The byte array to copy the bytes into</param>
        /// <param name="index">The first index into the array to copy the bytes into</param>
        public void CopyBytes(uint[] values, byte[] buffer, int index)
        {
            foreach (var value in values)
            {
                CopyBytes(value, buffer, index);
        ...
        /// <summary>
        /// Copies the specified 64-bit unsigned integer values into the specified byte array,
        /// beginning at the specified index.
        /// </summary>
        /// <param name="values">A Boolean value.</param>
        /// <param name="buffer">The byte array to copy the bytes into</param>
        /// <param name="index">The first index into the array to copy the bytes into</param>
        public void CopyBytes(ulong[] values, byte[] buffer, int index)
        {
            foreach (var value in values)
            {
                CopyBytes(value, buffer, index);
